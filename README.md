...
Use this repo when you want to see, verify, and demo real proof artifacts without first instrumenting your own codebase. It is the fastest no-integration way to understand what Assay produces under pass, honest-fail, and tamper conditions.
